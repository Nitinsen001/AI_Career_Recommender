...
CAREER_ROADMAPS = {
    'Data Scientist': [
        {'step': 1, 'title': 'Mathematics & Statistics', 'desc': 'Linear Algebra, Calculus, Probability, Statistics'},
        {'step': 2, 'title': 'Programming Basics', 'desc': 'Python, SQL, Git, Data Structures'},
        {'step': 3, 'title': 'Data Manipulation', 'desc': 'Pandas, NumPy, Data Cleaning, EDA'},
        {'step': 4, 'title': 'Machine Learning', 'desc': 'Scikit-Learn, Supervised/Unsupervised Learning'},
        {'step': 5, 'title': 'Deep Learning', 'desc': 'TensorFlow, PyTorch, Neural Networks'},
        {'step': 6, 'title': 'Deployment', 'desc': 'Flask, Docker, AWS/Azure, MLOps'},
    ],
    'Web Developer': [
        {'step': 1, 'title': 'Frontend Basics', 'desc': 'HTML5, CSS3, JavaScript (ES6+)'},
        {'step': 2, 'title': 'Frontend Frameworks', 'desc': 'React.js, Vue.js, or Angular'},
        {'step': 3, 'title': 'Backend Basics', 'desc': 'Node.js, Python (Django/Flask), or Java'},
        {'step': 4, 'title': 'Databases', 'desc': 'SQL (PostgreSQL) and NoSQL (MongoDB)'},
        {'step': 5, 'title': 'DevOps & Deployment', 'desc': 'Git, Docker, CI/CD, Cloud Hosting'},
    ],
    'Software Engineer': [
        {'step': 1, 'title': 'CS Fundamentals', 'desc': 'Algorithms, Data Structures, OS, Networking'},
        {'step': 2, 'title': 'Proficiency in One Language', 'desc': 'Java, C++, Python, or Go'},
        {'step': 3, 'title': 'System Design', 'desc': 'Scalability, Microservices, Distributed Systems'},
        {'step': 4, 'title': 'Database Design', 'desc': 'SQL, NoSQL, Caching, Indexing'},
        {'step': 5, 'title': 'Testing & Quality', 'desc': 'Unit Testing, Integration Testing, CI/CD'},
    ],
    'AI Engineer': [
        {'step': 1, 'title': 'Programming & Math', 'desc': 'Python, Linear Algebra, Calculus'},
        {'step': 2, 'title': 'Machine Learning Core', 'desc': 'Regression, Classification, Clustering'},
        {'step': 3, 'title': 'Deep Learning', 'desc': 'CNNs, RNNs, Transformers, GANs'},
        {'step': 4, 'title': 'NLP & Computer Vision', 'desc': 'OpenCV, Hugging Face, Spacy'},
        {'step': 5, 'title': 'MLOps', 'desc': 'Model Serving, Monitoring, Pipelines'},
    ],
    'Data Analyst': [
        {'step': 1, 'title': 'Excel & Spreadsheets', 'desc': 'Advanced Formulas, Pivot Tables, VBA'},
        {'step': 2, 'title': 'SQL', 'desc': 'Querying, Joins, Aggregations, Window Functions'},
        {'step': 3, 'title': 'BI Tools', 'desc': 'Tableau, PowerBI, or Looker'},
        {'step': 4, 'title': 'Python/R', 'desc': 'Pandas, Matplotlib, Seaborn'},
        {'step': 5, 'title': 'Statistics', 'desc': 'Hypothesis Testing, A/B Testing'},
    ]
}
...
SKILL_RESOURCES = {
    'python': {
        'youtube': [
            {'title': 'Python for Beginners (Full Course)', 'channel': 'Programming with Mosh', 'url': 'https://www.youtube.com/watch?v=_uQrJ0TkZlc'},
            {'title': 'Python Tutorial for Beginners', 'channel': 'Telusko', 'url': 'https://www.youtube.com/watch?v=hEgO047GxaQ'},
        ],
        'courses': [
            {'title': '100 Days of Code: The Complete Python Pro Bootcamp', 'platform': 'Udemy', 'url': 'https://www.udemy.com/course/100-days-of-code/'},
            {'title': 'Python for Everybody', 'platform': 'Coursera', 'url': 'https://www.coursera.org/specializations/python'},
        ]
    },
    'machine learning': {
        'youtube': [
            {'title': 'Machine Learning for Everybody', 'channel': 'freeCodeCamp', 'url': 'https://www.youtube.com/watch?v=i_LwzRVP7bg'},
            {'title': 'Machine Learning Course', 'channel': 'Andrew Ng', 'url': 'https://www.youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU'},
        ],
        'courses': [
            ...
            {'title': 'Hands-On Machine Learning with Scikit-Learn', 'platform': 'O\'Reilly', 'url': '#'},
        ]
    },
    'data analysis': {
        'youtube': [
            {'title': 'Data Analysis with Python Course', 'channel': 'freeCodeCamp', 'url': 'https://www.youtube.com/watch?v=r-uOLxNrNk4'},
        ],
        'courses': [
            {'title': 'Google Data Analytics Professional Certificate', 'platform': 'Coursera', 'url': 'https://www.coursera.org/professional-certificates/google-data-analytics'},
        ]
    },
    'sql': {
        'youtube': [
            {'title': 'SQL Tutorial - Full Database Course', 'channel': 'freeCodeCamp', 'url': 'https://www.youtube.com/watch?v=HXV3zeQKqGY'},
        ],
        'courses': [
    ...
    'reactjs': {
        'youtube': [
            {'title': 'React JS - React Tutorial for Beginners', 'channel': 'Programming with Mosh', 'url': 'https://www.youtube.com/watch?v=Ke90Tje7VS0'},
        ],
        'courses': [
    ...
    'javascript': {
        'youtube': [
            {'title': 'JavaScript Tutorial for Beginners', 'channel': 'Programming with Mosh', 'url': 'https://www.youtube.com/watch?v=W6NZfCO5SIk'},
        ],
        'courses': [
    ...
    'django': {
        'youtube': [
            {'title': 'Python Django Tutorial for Beginners', 'channel': 'Programming with Mosh', 'url': 'https://www.youtube.com/watch?v=rHux0gMz3Eg'},
        ],
        'courses': [
    ...
    'c++': {
        'youtube': [
            {'title': 'C++ Tutorial for Beginners', 'channel': 'freeCodeCamp', 'url': 'https://www.youtube.com/watch?v=vLnPwxZdW4Y'},
        ],
        'courses': [
    ...
    'java': {
        'youtube': [
            {'title': 'Java Tutorial for Beginners', 'channel': 'Programming with Mosh', 'url': 'https://www.youtube.com/watch?v=eIrMbAQSU34'},
        ],
        'courses': [
    ...
    'cloud computing': {
        'youtube': [
            {'title': 'Cloud Computing for Beginners', 'channel': 'Simplilearn', 'url': 'https://www.youtube.com/watch?v=M988_fsOSWo'},
        ],
        'courses': [
